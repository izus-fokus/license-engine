...
public class UrlUpload implements OneOfbody {
    ...
    @Schema(description = "URL for file/folder to be uploaded")
    ...
    public String toString() {
        ...
        return "class UrlUpload {\n" +
                "    url: " + toIndentedString(url) + "\n" +
                "    name: " + toIndentedString(name) + "\n" +
                "    accept: " + toIndentedString(accept) + "\n" +
                "    reject: " + toIndentedString(reject) + "\n" +
                "    maxRecursionDepth: " + toIndentedString(maxRecursionDepth) + "\n" +
                "}";
    }
